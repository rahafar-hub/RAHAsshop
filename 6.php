...
<header>
    ...
    <h1 class="anim">درباره من</h1>
    <div class="container anim">
      
        <p class="anim">
            من رهابگری هستم .
             برنامه نویس و توسعه دهنده وب هم فراتند و بکند
              ،همچنین تلاش میکنم با طراحی های ساده و شکیل سایت های جذابی رو برای کاربران بسازم
        </p>
        <img src="pics/aboutmepic.png" alt="pic" style="width: 300px;height:350px;">
    </div>
